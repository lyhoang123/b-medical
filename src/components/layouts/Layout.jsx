        ...
        <HStack w={'80%'} margin="0 auto" padding={'28px 16px'} display="flex">
          <Box w={'30%'} mr={'50px'}>
            ...
            <Box color="white !important">
              <p>
                B-Medical system for traceability and supply chain management of drugs and medical devices applying
            ...
            <Box color="white !important">
              <ButtonGroup variant="ghost" margin={'0'} padding="0">
                ...
                <IconButton as="a" href="#" aria-label="Twitter" icon={<FaFacebook fontSize="1.25rem" />} />
                <IconButton as="a" href="#" aria-label="Twitter" icon={<FaReact fontSize="1.25rem" />} />
              </ButtonGroup>
            </Box>
          </Box>
          ...
          <Box color="white !important" w={'25%'} margin="0">
            ...
            <Button bg={'#fff'} borderRadius="8px" type="submit" flexShrink={0} mt="24px">
